var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function n(e,t=document){return t.querySelector(e)}function r(e,t,n,r){t.innerHTML=e,r&&r(n)}async function i(e){let t=`/StyleRecordLite/`+e.replace(/^\//,``);return await(await fetch(t)).text()}async function a(){let e=await i(`partials/header.html`),t=await i(`partials/footer.html`),a=n(`#main-header`),o=n(`#main-footer`);r(e,a),r(t,o)}function o(e){let t=document.createElement(`div`);return t.appendChild(document.createTextNode(e)),t.innerHTML}function s(e,t=300){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)}}var c=`/StyleRecordLite/`,l=t({getRole:()=>m,isAuthenticated:()=>g,loginAsClient:()=>p,loginAsProfessional:()=>f,logout:()=>h}),u=`sr-role`,d=`1234`;function f(e){if(e===d)try{return localStorage.setItem(u,`professional`),!0}catch(e){return console.error(`Error al guardar rol:`,e),!1}return!1}function p(e){try{localStorage.setItem(u,`client`),localStorage.setItem(`sr-client-phone`,e)}catch(e){console.error(`Error al guardar rol de cliente:`,e)}}function m(){try{return localStorage.getItem(u)}catch(e){return console.error(`Error al leer rol:`,e),null}}function h(){try{localStorage.removeItem(u),localStorage.removeItem(`sr-client-phone`)}catch(e){console.error(`Error al cerrar sesión:`,e)}}function g(){return m()!==null}var ee=`sr-temp-links`;function te(){try{let e=localStorage.getItem(ee);return e?JSON.parse(e):[]}catch(e){return console.error(`Error al cargar enlaces temporales:`,e),[]}}function ne(e){try{return localStorage.setItem(ee,JSON.stringify(e)),!0}catch(e){return console.error(`Error al guardar enlaces temporales:`,e),!1}}function re(e){let t=`tok_`+(crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2,9)),n=te();return n.push({token:t,clientId:e,expiresAt:Date.now()+1440*60*1e3}),ne(n),t}function ie(e){let t=te(),n=t.find(t=>t.token===e);return n?Date.now()>n.expiresAt?(ne(t.filter(t=>t.token!==e)),null):n.clientId:null}function ae(){ne(te().filter(e=>Date.now()<=e.expiresAt))}var oe=class{constructor(){this.routes={},window.addEventListener(`hashchange`,()=>this.resolve())}addRoute(e,t){this.routes[e]=t}navigate(e){window.location.hash=e}resolve(){let[e]=(window.location.hash.slice(1)||`/`).split(`?`),t=this.routes[e]||this.routes[`*`];t&&t()}start(){window.location.hash?this.resolve():window.location.hash=`/home`}};function se(){return new oe}var _={es:{appName:`StyleRecord Lite`,login:`Accede a StyleRecord`,professional:`Soy Profesional`,client:`Soy Cliente`,search:`Buscar cliente...`,newClient:`Nuevo Cliente`,addService:`Agregar Servicio`,edit:`Editar`,delete:`Eliminar`,confirmDeleteClient:`¿Eliminar este cliente y todos sus servicios?`,confirmDeleteService:`¿Eliminar este servicio?`,saved:`Guardado`,invalidCode:`Código incorrecto. Prueba con 1234`,noClient:`No se encontró un cliente con ese número.`,noClients:`No hay clientes registrados.`,emptyHint:`Agrega tu primer cliente con el botón "Nuevo Cliente".`,noServices:`Este cliente no tiene servicios registrados.`,noHistory:`No tienes servicios registrados aún.`,linkExpired:`Enlace expirado o inválido`,linkExpiredMsg:`Este enlace ha caducado (24 horas) o no es correcto. Pide a tu profesional un nuevo enlace.`,sharedBanner:`Vista temporal – Este enlace expirará`,shareProfile:`Compartir Perfil`,copyLink:`Copiar`,copied:`¡Copiado!`,offline:`Sin conexión a internet. Algunas funciones pueden no estar disponibles.`,clientCreated:`Cliente creado correctamente`,clientUpdated:`Cliente actualizado`,clientDeleted:`Cliente eliminado`,serviceAdded:`Servicio agregado`,serviceUpdated:`Servicio actualizado`,serviceDeleted:`Servicio eliminado`,phoneExists:`El teléfono ya está registrado.`,invalidPhone:`El número no es válido.`,manualSave:`Guardar de todas formas`,saveManually:`Guardar manualmente`,validateAndSave:`Validar y Guardar`,validating:`Validando...`,before:`Antes`,after:`Después`,beforeImageAlt:`Antes del servicio`,afterImageAlt:`Después del servicio`,editService:`Editar servicio`,deleteService:`Eliminar servicio`,editClient:`Editar`,deleteClient:`Eliminar`,clientAriaLabel:`Cliente`,noServicesShort:`Sin servicios`,addServiceHint:`Usa "Agregar Servicio" para añadir uno.`,historyOf:`Historial de`,yes:`Sí, eliminar`,cancel:`Cancelar`,confirmTitle:`Confirmar acción`,serviceAriaLabel:`Servicio`},en:{appName:`StyleRecord Lite`,login:`Log in to StyleRecord`,professional:`I am a Professional`,client:`I am a Client`,search:`Search client...`,newClient:`New Client`,addService:`Add Service`,edit:`Edit`,delete:`Delete`,confirmDeleteClient:`Delete this client and all services?`,confirmDeleteService:`Delete this service?`,saved:`Saved`,invalidCode:`Incorrect code. Try 1234`,noClient:`No client found with that number.`,noClients:`No registered clients.`,emptyHint:`Add your first client using the "New Client" button.`,noServices:`This client has no registered services.`,noHistory:`You have no registered services yet.`,linkExpired:`Link expired or invalid`,linkExpiredMsg:`This link has expired (24 hours) or is incorrect. Ask your professional for a new link.`,sharedBanner:`Temporary view – This link will expire`,shareProfile:`Share Profile`,copyLink:`Copy`,copied:`Copied!`,offline:`No internet connection. Some features may not be available.`,clientCreated:`Client created successfully`,clientUpdated:`Client updated`,clientDeleted:`Client deleted`,serviceAdded:`Service added`,serviceUpdated:`Service updated`,serviceDeleted:`Service deleted`,phoneExists:`Phone number already registered.`,invalidPhone:`Invalid phone number.`,manualSave:`Save anyway`,saveManually:`Save manually`,validateAndSave:`Validate & Save`,validating:`Validating...`,before:`Before`,after:`After`,beforeImageAlt:`Before the service`,afterImageAlt:`After the service`,editService:`Edit service`,deleteService:`Delete service`,editClient:`Edit`,deleteClient:`Delete`,clientAriaLabel:`Client`,noServicesShort:`No services`,addServiceHint:`Use "Add Service" to add one.`,historyOf:`History of`,yes:`Yes, delete`,cancel:`Cancel`,confirmTitle:`Confirm action`,serviceAriaLabel:`Service`}},v=localStorage.getItem(`sr-lang`)||navigator.language.split(`-`)[0]||`es`;_[v]||(v=`es`);function y(e){return _[v]?.[e]||_.es[e]||e}function ce(e){e.innerHTML=`
        ...
        <div class="login-client-visual">
          <div class="visual-grid">
            <div class="visual-img-wrapper">
              <img src="${N(600,400,`salon`)}" alt="Salón moderno" loading="lazy" />
              <div class="visual-overlay"></div>
            </div>
            <div class="visual-img-wrapper">
              <img src="${N(600,600,`productos`)}" alt="Productos de belleza" loading="lazy" />
              <div class="visual-overlay"></div>
            </div>
          </div>
  ...
  `}function F(e,t){return!e||!e.trim()?`${t} es obligatorio.`:null}function lt(e){return/^\+?[1-9]\d{6,14}$/.test(e.trim())?null:`Formato de teléfono inválido. Ej: +541112345678`}function ut(e){let t=new Date(e),n=new Date;return n.setHours(0,0,0,0),t>n?`La fecha no puede ser futura.`:null}function dt(e,t){let n={},r=F(e,`Nombre`);r&&(n.name=r);let i=F(t,`Teléfono`)||lt(t);return i&&(n.phone=i),n}function ft(e,t,n){let r={};e||(r.type=`Tipo de servicio es obligatorio.`);let i=F(t,`Fecha`)||ut(t);return i&&(r.date=i),r}function pt(e){return e?null:`Selecciona un tipo de profesional.`}function mt(e){return e?null:`Selecciona una modalidad.`}function ht(e){return!e||!e.trim()?`El nombre del local es obligatorio.`:null}function gt(e){return!e||!e.trim()?`La dirección es obligatoria.`:null}function _t(e){return!e||!e.trim()?`El nombre de la empresa es obligatorio.`:null}var I=null;function L(e){I=e}var R=null;function vt(){R||(R=document.createElement(`div`),R.className=`lightbox-overlay hidden`,R.innerHTML=`
    ...
    ${t.length>0?`
      <section class="recent-clients-section">
        ...
        <div class="recent-clients-list">
          ${t.slice(0,5).map(e=>{let t=e.name.split(` `).map(e=>e[0]).join(``).toUpperCase().substring(0,2),n=e.services?.length?e.services.reduce((e,t)=>new Date(t.date)>new Date(e.date)?t:e):null,r=n?`${jt(n.date)} · ${o(n.type)}`:`Sin servicios`;return`
  ...
  `,e.querySelectorAll(`.recent-client-card`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=t.dataset.clientId;L(n),await Y(n,e)})})}function kt(e,t){if(t.length===0){e.innerHTML=`<p class="sidebar-empty">Sin clientes</p>`;return}e.innerHTML=t.map(e=>{let t=e.name.split(` `).map(e=>e[0]).join(``).toUpperCase().substring(0,2),n=e.services?.length?e.services.reduce((e,t)=>new Date(t.date)>new Date(e.date)?t:e):null,r=n?jt(n.date):`Sin servicios`;return`
    ...
    `}).join(``)}async function Y(e,t){let n=await We(e);if(!n){t.innerHTML=`<p>Cliente no encontrado.</p>`;return}let r=await P(e),i=[...r].sort((e,t)=>new Date(t.date)-new Date(e.date));t.innerHTML=`
    <!-- Client Header -->
  ...
  `,document.getElementById(`btn-back-dashboard`).addEventListener(`click`,()=>{J&&J()});let a=document.getElementById(`btn-toggle-services`),s=document.getElementById(`services-grid`),c=!0;a.addEventListener(`click`,()=>{c=!c,s.style.display=c?``:`none`,a.querySelector(`span:last-child`).textContent=c?`Ocultar servicios`:`Mostrar servicios`,a.querySelector(`.material-symbols-outlined`).textContent=c?`visibility_off`:`visibility`}),document.getElementById(`btn-edit-profile`).addEventListener(`click`,()=>Nt(n)),document.getElementById(`add-service-area`).addEventListener(`click`,()=>Pt()),t.querySelectorAll(`.btn-edit-service-dash`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),Ft(e.dataset.id)})}),t.querySelectorAll(`.btn-delete-service-dash`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),It(e.dataset.id)})})}function At(e){let t=[];e.beforeImg&&t.push(e.beforeImg),e.afterImg&&t.push(e.afterImg),e.afterLateralImg&&t.push(e.afterLateralImg);let n=o(JSON.stringify(t)),r=t.indexOf(e.beforeImg),i=t.indexOf(e.afterImg),a=t.indexOf(e.afterLateralImg),s=new Date(e.date),c=s.getDate(),l=s.toLocaleString(`es-ES`,{month:`short`}),u=s.getFullYear();return`
  ...
  `}function jt(e){let t=new Date,n=new Date(e),r=t-n,i=Math.floor(r/6e4);if(i<60)return`Hace ${i} minutos`;let a=Math.floor(i/60);if(a<24)return`Hace ${a} horas`;let o=Math.floor(a/24);return o===1?`Ayer`:o<7?`Hace ${o} días`:n.toLocaleDateString(`es-ES`)}async function Mt(){W(`Nuevo Cliente`,`
  ...
  `),document.getElementById(`new-client-form`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`client-name`).value.trim(),n=document.getElementById(`client-country`).value,r=Je(n,document.getElementById(`client-phone`).value.trim()),i=dt(t,r);if(X(`client`,i),Object.keys(i).length>0)return;let a=document.getElementById(`validate-btn`),s=document.getElementById(`validation-area`);if((await O()).find(e=>e.phone===r)){s.innerHTML=`<div class="validation-error">El teléfono ya está registrado.</div>`;return}a.disabled=!0,a.innerHTML=`<span class="spinner"></span> Validando...`,s.innerHTML=``;try{let e=await at(r);s.innerHTML=`
        <div class="validation-result">
        ...
        </div>`,await Ge({id:Date.now().toString(36)+Math.random().toString(36).substr(2),name:t,phone:r,phoneValid:!0,phoneDetails:{country:e.country_name,carrier:e.carrier,line_type:e.line_type},services:[]}),G(),await K(),M(`Cliente creado correctamente`)}catch(e){e.name===`InvalidPhoneError`?(s.innerHTML=`
          ...
          <button type="button" id="force-save-btn">Guardar manualmente</button>`,document.getElementById(`force-save-btn`).addEventListener(`click`,async()=>{await Ge({id:Date.now().toString(36)+Math.random().toString(36).substr(2),name:t,phone:r,phoneValid:!1,phoneDetails:null,services:[]}),G(),await K()})):s.innerHTML=`<div class="validation-error">${o(e.message)}</div>`}finally{a.disabled=!1,a.innerHTML=`Validar y Guardar`}})}async function Nt(e){W(`Editar Cliente`,ot(e)),document.getElementById(`edit-client-form`).addEventListener(`submit`,async t=>{t.preventDefault();let n=document.getElementById(`edit-client-name`).value.trim(),r=document.getElementById(`edit-client-phone`).value.trim(),i=dt(n,r);if(X(`edit-client`,i),Object.keys(i).length>0)return;await Ke(e.id,{name:n,phone:r}),G(),await K();let a=document.getElementById(`main-content-area`);I===e.id&&await Y(e.id,a),M(`Cliente actualizado`)})}async function Pt(){if(!I){j(`Selecciona un cliente primero.`);return}let e=Ye();W(`Agregar Servicio`,st(e.beforeImg,e.afterImg,e.afterLateralImg));let t=document.getElementById(`new-service-form`),n=e.beforeImg,r=e.afterImg,i=e.afterLateralImg;document.getElementById(`btn-regenerate-images`).addEventListener(`click`,()=>{let e=Ye();n=e.beforeImg,r=e.afterImg,i=e.afterLateralImg,document.getElementById(`preview-before`).src=n,document.getElementById(`preview-after-frontal`).src=r,document.getElementById(`preview-after-lateral`).src=i}),t.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`service-type`).value,a=document.getElementById(`service-date`).value,o=document.getElementById(`service-notes`).value.trim(),s=ft(t,a,o);X(`service`,s),!(Object.keys(s).length>0)&&(await $e(I,{id:Date.now().toString(36)+Math.random().toString(36).substr(2),clientId:I,date:a,type:t,notes:o,beforeImg:n,afterImg:r,afterLateralImg:i}),G(),await Y(I,document.getElementById(`main-content-area`)),M(`Servicio agregado`))})}async function Ft(e){let t=(await P(I)).find(t=>t.id===e);t&&(W(`Editar Servicio`,ct(t)),document.getElementById(`edit-service-form`).addEventListener(`submit`,async t=>{t.preventDefault();let n=document.getElementById(`edit-service-type`).value,r=document.getElementById(`edit-service-date`).value,i=document.getElementById(`edit-service-notes`).value.trim(),a=ft(n,r,i);X(`edit-service`,a),!(Object.keys(a).length>0)&&(await et(I,e,{type:n,date:r,notes:i}),G(),await Y(I,document.getElementById(`main-content-area`)),M(`Servicio actualizado`))}))}async function It(e){await wt(`¿Eliminar este servicio?`)&&(await tt(I,e),await Y(I,document.getElementById(`main-content-area`)),M(`Servicio eliminado`))}function X(e,t){[`name`,`phone`,`type`,`date`].forEach(n=>{let r=document.getElementById(`error-${e}-${n}`);r&&(r.textContent=t[n]||``)})}async function Lt(e){let t=localStorage.getItem(`sr-client-phone`);if(!t){e.innerHTML=`<p class="login-support">No se encontró sesión de cliente.</p>`;return}let n=await Ue(t);if(!n){e.innerHTML=`<p class="login-support">Perfil de cliente no encontrado.</p>`;return}let r=await P(n.id),i=[...r].sort((e,t)=>new Date(t.date)-new Date(e.date)),a=r.length,s=r.length>0?new Date(i[i.length-1].date).getFullYear():new Date().getFullYear(),c=re(n.id),l=`${window.location.origin}${window.location.pathname}?token=${c}`;e.innerHTML=`
  ...
  `}function zt(e){return e.split(` `).map(e=>e[0]).join(``).toUpperCase().substring(0,2)}async function Bt(e,t){let n=ie(t);if(!n){e.innerHTML=`
      ...
      </section>`;return}let r=await We(n);if(!r){e.innerHTML=`<p>Perfil no encontrado.</p>`;return}let i=await P(n),a=[...i].sort((e,t)=>new Date(t.date)-new Date(e.date)),s=i.length,c=a.length>0?a[0]:null;e.innerHTML=`
  ...
  `;let n=document.getElementById(`btn-cancel`);if(n&&n.addEventListener(`click`,()=>{window.location.hash=`/rol`}),Z>0){let t=document.getElementById(`btn-prev`);t&&t.addEventListener(`click`,()=>{Z--,$(e)})}let r=document.getElementById(`btn-next`);r&&r.addEventListener(`click`,()=>tn(e)),Z===0&&on(),Z===1&&sn()}function Yt(e){switch(e){case 0:return`Información Profesional`;case 1:return`Detalles del Negocio`;case 2:return`Resumen del Registro`;default:return``}}function Xt(e){switch(e){case 0:return`Completa los detalles de tu especialidad para comenzar a gestionar tu agenda con StyleRecord Lite.`;case 1:return Q.modality===`independent`?`Configura los datos de tu actividad independiente.`:`Vincula tu perfil con la empresa donde trabajas.`;case 2:return`Revisa que toda la información sea correcta antes de finalizar.`;default:return``}}function Zt(e){switch(e){case 0:return Qt();case 1:return $t();case 2:return en();default:return``}}function Qt(){return`
    <form id="step0-form" class="register-form">
      ...
      <div class="register-decoration">
        <img src="${N(800,200,`salon-deco`)}" alt="Salón profesional" loading="lazy" />
