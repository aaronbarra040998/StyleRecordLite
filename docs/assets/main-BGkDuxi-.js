var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function n(e,t=document){return t.querySelector(e)}function r(e,t,n,r){t.innerHTML=e,r&&r(n)}async function i(e){let t=`/StyleRecordLite/`+e.replace(/^\//,``);return await(await fetch(t)).text()}async function a(){let e=await i(`partials/header.html`),t=await i(`partials/footer.html`),a=n(`#main-header`),o=n(`#main-footer`);r(e,a),r(t,o)}function o(e){let t=document.createElement(`div`);return t.appendChild(document.createTextNode(e)),t.innerHTML}function s(e,t=300){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)}}var c=`/StyleRecordLite/`,l=t({getRole:()=>p,isAuthenticated:()=>h,loginAsClient:()=>f,loginAsProfessional:()=>d,logout:()=>m}),u=`sr-role`,ee=`1234`;function d(e){if(e===ee)try{return localStorage.setItem(u,`professional`),!0}catch(e){return console.error(`Error al guardar rol:`,e),!1}return!1}function f(e){try{localStorage.setItem(u,`client`),localStorage.setItem(`sr-client-phone`,e)}catch(e){console.error(`Error al guardar rol de cliente:`,e)}}function p(){try{return localStorage.getItem(u)}catch(e){return console.error(`Error al leer rol:`,e),null}}function m(){try{localStorage.removeItem(u),localStorage.removeItem(`sr-client-phone`)}catch(e){console.error(`Error al cerrar sesión:`,e)}}function h(){return p()!==null}var te=`sr-temp-links`;function g(){try{let e=localStorage.getItem(te);return e?JSON.parse(e):[]}catch(e){return console.error(`Error al cargar enlaces temporales:`,e),[]}}function _(e){try{return localStorage.setItem(te,JSON.stringify(e)),!0}catch(e){return console.error(`Error al guardar enlaces temporales:`,e),!1}}function ne(e){let t=`tok_`+(crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).substr(2,9)),n=g();return n.push({token:t,clientId:e,expiresAt:Date.now()+1440*60*1e3}),_(n),t}function re(e){let t=g(),n=t.find(t=>t.token===e);return n?Date.now()>n.expiresAt?(_(t.filter(t=>t.token!==e)),null):n.clientId:null}function ie(){_(g().filter(e=>Date.now()<=e.expiresAt))}var ae=class{constructor(){this.routes={},window.addEventListener(`hashchange`,()=>this.resolve())}addRoute(e,t){this.routes[e]=t}navigate(e){window.location.hash=e}resolve(){let[e]=(window.location.hash.slice(1)||`/`).split(`?`),t=this.routes[e]||this.routes[`*`];t&&t()}start(){window.location.hash?this.resolve():window.location.hash=`/home`}};function oe(){return new ae}var v={es:{appName:`StyleRecord Lite`,login:`Accede a StyleRecord`,professional:`Soy Profesional`,client:`Soy Cliente`,search:`Buscar cliente...`,newClient:`Nuevo Cliente`,addService:`Agregar Servicio`,edit:`Editar`,delete:`Eliminar`,confirmDeleteClient:`¿Eliminar este cliente y todos sus servicios?`,confirmDeleteService:`¿Eliminar este servicio?`,saved:`Guardado`,invalidCode:`Código incorrecto. Prueba con 1234`,noClient:`No se encontró un cliente con ese número.`,noClients:`No hay clientes registrados.`,emptyHint:`Agrega tu primer cliente con el botón "Nuevo Cliente".`,noServices:`Este cliente no tiene servicios registrados.`,noHistory:`No tienes servicios registrados aún.`,linkExpired:`Enlace expirado o inválido`,linkExpiredMsg:`Este enlace ha caducado (24 horas) o no es correcto. Pide a tu profesional un nuevo enlace.`,sharedBanner:`Vista temporal – Este enlace expirará`,shareProfile:`Compartir Perfil`,copyLink:`Copiar`,copied:`¡Copiado!`,offline:`Sin conexión a internet. Algunas funciones pueden no estar disponibles.`,clientCreated:`Cliente creado correctamente`,clientUpdated:`Cliente actualizado`,clientDeleted:`Cliente eliminado`,serviceAdded:`Servicio agregado`,serviceUpdated:`Servicio actualizado`,serviceDeleted:`Servicio eliminado`,phoneExists:`El teléfono ya está registrado.`,invalidPhone:`El número no es válido.`,manualSave:`Guardar de todas formas`,saveManually:`Guardar manualmente`,validateAndSave:`Validar y Guardar`,validating:`Validando...`,before:`Antes`,after:`Después`,beforeImageAlt:`Antes del servicio`,afterImageAlt:`Después del servicio`,editService:`Editar servicio`,deleteService:`Eliminar servicio`,editClient:`Editar`,deleteClient:`Eliminar`,clientAriaLabel:`Cliente`,noServicesShort:`Sin servicios`,addServiceHint:`Usa "Agregar Servicio" para añadir uno.`,historyOf:`Historial de`,yes:`Sí, eliminar`,cancel:`Cancelar`,confirmTitle:`Confirmar acción`,serviceAriaLabel:`Servicio`},en:{appName:`StyleRecord Lite`,login:`Log in to StyleRecord`,professional:`I am a Professional`,client:`I am a Client`,search:`Search client...`,newClient:`New Client`,addService:`Add Service`,edit:`Edit`,delete:`Delete`,confirmDeleteClient:`Delete this client and all services?`,confirmDeleteService:`Delete this service?`,saved:`Saved`,invalidCode:`Incorrect code. Try 1234`,noClient:`No client found with that number.`,noClients:`No registered clients.`,emptyHint:`Add your first client using the "New Client" button.`,noServices:`This client has no registered services.`,noHistory:`You have no registered services yet.`,linkExpired:`Link expired or invalid`,linkExpiredMsg:`This link has expired (24 hours) or is incorrect. Ask your professional for a new link.`,sharedBanner:`Temporary view – This link will expire`,shareProfile:`Share Profile`,copyLink:`Copy`,copied:`Copied!`,offline:`No internet connection. Some features may not be available.`,clientCreated:`Client created successfully`,clientUpdated:`Client updated`,clientDeleted:`Client deleted`,serviceAdded:`Service added`,serviceUpdated:`Service updated`,serviceDeleted:`Service deleted`,phoneExists:`Phone number already registered.`,invalidPhone:`Invalid phone number.`,manualSave:`Save anyway`,saveManually:`Save manually`,validateAndSave:`Validate & Save`,validating:`Validating...`,before:`Before`,after:`After`,beforeImageAlt:`Before the service`,afterImageAlt:`After the service`,editService:`Edit service`,deleteService:`Delete service`,editClient:`Edit`,deleteClient:`Delete`,clientAriaLabel:`Client`,noServicesShort:`No services`,addServiceHint:`Use "Add Service" to add one.`,historyOf:`History of`,yes:`Yes, delete`,cancel:`Cancel`,confirmTitle:`Confirm action`,serviceAriaLabel:`Service`}},y=localStorage.getItem(`sr-lang`)||navigator.language.split(`-`)[0]||`es`;v[y]||(y=`es`);function b(e){return v[y]?.[e]||v.es[e]||e}function se(e){e.innerHTML=`
  ...
  `,document.getElementById(`btn-home-cta`).addEventListener(`click`,()=>{window.location.hash=`/rol`}),document.getElementById(`btn-ver-demo`).addEventListener(`click`,()=>{window.location.hash=`/login?role=professional`}),ce()}function ce(){let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`in-view`)})},{threshold:.1});document.querySelectorAll(`.glass-card, .featured-service-card`).forEach(t=>{t.classList.add(`reveal-on-scroll`),e.observe(t)})}function le(e){e.innerHTML=`
    <section class="role-selection">
      ...
      <div class="role-header">
        ...
        <h2 class="role-heading">${b(`login`)}</h2>
      ...
      <div class="role-cards">
        <!-- Profesional -->
        <button class="role-card" id="role-professional" aria-label="${b(`professional`)}">
        ...
        <!-- Cliente -->
        <button class="role-card" id="role-client" aria-label="${b(`client`)}">
  ...
  `,document.getElementById(`role-professional`).addEventListener(`click`,()=>{window.location.hash=`/login?role=professional`}),document.getElementById(`role-client`).addEventListener(`click`,()=>{window.location.hash=`/login?role=client`}),document.querySelectorAll(`.role-card`).forEach(e=>{e.addEventListener(`keydown`,t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),e.click())})})}var x=(e,t)=>t.some(t=>e instanceof t),ue,de;function fe(){return ue||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function pe(){return de||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var me=new WeakMap,S=new WeakMap,C=new WeakMap;function he(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(T(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return C.set(t,e),t}function ge(e){if(me.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});me.set(e,t)}var w={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return me.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return T(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)?!0:t in e}};function _e(e){w=e(w)}function ve(e){return pe().includes(e)?function(...t){return e.apply(E(this),t),T(this.request)}:function(...t){return T(e.apply(E(this),t))}}function ye(e){return typeof e==`function`?ve(e):(e instanceof IDBTransaction&&ge(e),x(e,fe())?new Proxy(e,w):e)}function T(e){if(e instanceof IDBRequest)return he(e);if(S.has(e))return S.get(e);let t=ye(e);return t!==e&&(S.set(e,t),C.set(t,e)),t}var E=e=>C.get(e);function be(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=T(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(T(o.result),e.oldVersion,e.newVersion,T(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}var xe=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],Se=[`put`,`add`,`delete`,`clear`],D=new Map;function Ce(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(D.get(t))return D.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=Se.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||xe.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return D.set(t,a),a}_e(e=>({...e,get:(t,n,r)=>Ce(t,n)||e.get(t,n,r),has:(t,n)=>!!Ce(t,n)||e.has(t,n)}));var we=[`continue`,`continuePrimaryKey`,`advance`],Te={},O=new WeakMap,Ee=new WeakMap,De={get(e,t){if(!we.includes(t))return e[t];let n=Te[t];return n||=Te[t]=function(...e){O.set(this,Ee.get(this)[t](...e))},n}};async function*Oe(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,De);for(Ee.set(n,t),C.set(n,E(t));t;)yield n,t=await(O.get(n)||t.continue()),O.delete(n)}function ke(e,t){return t===Symbol.asyncIterator&&x(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&x(e,[IDBIndex,IDBObjectStore])}_e(e=>({...e,get(t,n,r){return ke(t,n)?Oe:e.get(t,n,r)},has(t,n){return ke(t,n)||e.has(t,n)}}));var Ae=`stylerecord-db`,je=2,Me;function k(){return Me||=be(Ae,je,{upgrade(e,t,n,r){if(e.objectStoreNames.contains(`clients`)||e.createObjectStore(`clients`,{keyPath:`id`}),t<2&&(e.objectStoreNames.contains(`professionals`)||e.createObjectStore(`professionals`,{keyPath:`id`}),e.objectStoreNames.contains(`companies`)||e.createObjectStore(`companies`,{keyPath:`id`}).createIndex(`name`,`name`,{unique:!1}),!e.objectStoreNames.contains(`linkRequests`))){let t=e.createObjectStore(`linkRequests`,{keyPath:`id`});t.createIndex(`professionalId`,`professionalId`,{unique:!1}),t.createIndex(`companyId`,`companyId`,{unique:!1})}}}),Me}async function Ne(){return(await k()).getAll(`clients`)}async function Pe(e){let t=(await k()).transaction(`clients`,`readwrite`);await t.store.clear();for(let n of e)await t.store.put(n);await t.done}async function Fe(e){await(await k()).add(`clients`,e)}async function Ie(e,t){let n=await k(),r=await n.get(`clients`,e);return r?(Object.assign(r,t),await n.put(`clients`,r),!0):!1}async function Le(e){await(await k()).put(`professionals`,e)}async function Re(e){await(await k()).put(`companies`,e)}async function ze(e){let t=(await k()).transaction(`companies`,`readonly`).store.index(`name`),n=IDBKeyRange.bound(e,e+`￿`,!1,!1);return t.getAll(n)}async function Be(e){await(await k()).add(`linkRequests`,e)}async function A(){try{return await Ne()}catch(e){return console.error(`Error al cargar clientes:`,e),[]}}async function j(e){try{return await Pe(e),!0}catch(e){return console.error(`Error al guardar clientes:`,e),!1}}async function Ve(e){return(await A()).find(t=>t.phone===e)}async function He(e){return(await A()).find(t=>t.id===e)}async function Ue(e){try{return await Fe(e),!0}catch(e){return console.error(`Error al agregar cliente:`,e),!1}}async function We(e,t){try{let n=await Ie(e,t);return n||console.warn(`Cliente con id ${e} no encontrado para actualizar.`),n}catch(e){return console.error(`Error al actualizar cliente:`,e),!1}}function M(e,t=`info`){let n=document.createElement(`div`);n.className=`toast toast-${t}`,n.textContent=e,document.body.appendChild(n),setTimeout(()=>{n.classList.add(`fade-out`),n.addEventListener(`transitionend`,()=>n.remove())},3e3)}function N(e){M(e,`error`)}function P(e){M(e,`success`)}var Ge=[{code:`AR`,name:`Argentina`,dialCode:`+54`,flag:`🇦🇷`},{code:`BO`,name:`Bolivia`,dialCode:`+591`,flag:`🇧🇴`},{code:`BR`,name:`Brasil`,dialCode:`+55`,flag:`🇧🇷`},{code:`CL`,name:`Chile`,dialCode:`+56`,flag:`🇨🇱`},{code:`CO`,name:`Colombia`,dialCode:`+57`,flag:`🇨🇴`},{code:`CR`,name:`Costa Rica`,dialCode:`+506`,flag:`🇨🇷`},{code:`CU`,name:`Cuba`,dialCode:`+53`,flag:`🇨🇺`},{code:`DO`,name:`República Dominicana`,dialCode:`+1`,flag:`🇩🇴`},{code:`EC`,name:`Ecuador`,dialCode:`+593`,flag:`🇪🇨`},{code:`ES`,name:`España`,dialCode:`+34`,flag:`🇪🇸`},{code:`GT`,name:`Guatemala`,dialCode:`+502`,flag:`🇬🇹`},{code:`HN`,name:`Honduras`,dialCode:`+504`,flag:`🇭🇳`},{code:`MX`,name:`México`,dialCode:`+52`,flag:`🇲🇽`},{code:`NI`,name:`Nicaragua`,dialCode:`+505`,flag:`🇳🇮`},{code:`PA`,name:`Panamá`,dialCode:`+507`,flag:`🇵🇦`},{code:`PY`,name:`Paraguay`,dialCode:`+595`,flag:`🇵🇾`},{code:`PE`,name:`Perú`,dialCode:`+51`,flag:`🇵🇪`},{code:`US`,name:`Estados Unidos`,dialCode:`+1`,flag:`🇺🇸`},{code:`UY`,name:`Uruguay`,dialCode:`+598`,flag:`🇺🇾`},{code:`VE`,name:`Venezuela`,dialCode:`+58`,flag:`🇻🇪`}];function Ke(e,t){return e+t.replace(/[^0-9]/g,``).replace(/^0+/,``)}function F(e=300,t=200,n=null){return`https://picsum.photos/${n?`seed/${n}/`:``}${e}/${t}`}function qe(){let e=Math.random().toString(36).substring(2,10),t=Math.random().toString(36).substring(2,10),n=Math.random().toString(36).substring(2,10);return{beforeImg:F(300,200,e),afterImg:F(300,200,t),afterLateralImg:F(300,200,n)}}function Je(e){let t=window.location.hash,n=new URLSearchParams(t.split(`?`)[1]||``).get(`role`);if(!n||n!==`professional`&&n!==`client`){window.location.hash=`/rol`;return}n===`professional`?Ye(e):Xe(e)}function Ye(e){e.innerHTML=`
  ...
  `;let t=document.getElementById(`professional-login-card`);t&&window.matchMedia(`(hover: hover)`).matches&&document.addEventListener(`mousemove`,e=>{let{clientX:n,clientY:r}=e,i=(n/window.innerWidth-.5)*10,a=(r/window.innerHeight-.5)*10;t.style.transform=`translate(${i}px, ${a}px)`}),document.getElementById(`login-form`).addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`prof-code`).value;d(t)?window.location.hash=`/professional`:N(b(`invalidCode`))})}function Xe(e){e.innerHTML=`
              ...
              <div class="login-form-group">
                ...
                <div class="select-wrapper">
                  <select id="country-select" required>
                    ${Ge.map(e=>`<option value="${e.dialCode}" ${e.code===`PE`?`selected`:``}>${e.flag} ${e.name} (${e.dialCode})</option>`).join(``)}
                  </select>
  ...
  `,document.getElementById(`login-form`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`country-select`).value,n=Ke(t,document.getElementById(`login-phone`).value.trim());await Ve(n)?(f(n),window.location.hash=`/client`):N(b(`noClient`))})}async function I(e){let t=(await A()).find(t=>t.id===e);return t?t.services:[]}async function Ze(e,t){let n=await A(),r=n.find(t=>t.id===e);return r?(Array.isArray(r.services)||(r.services=[]),r.services.push(t),await j(n),!0):!1}async function Qe(e,t,n){let r=await A(),i=r.find(t=>t.id===e);if(!i)return!1;let a=i.services.findIndex(e=>e.id===t);return a===-1?!1:(i.services[a]={...i.services[a],...n},await j(r),!0)}async function $e(e,t){let n=await A(),r=n.find(t=>t.id===e);return r?(r.services=r.services.filter(e=>e.id!==t),await j(n),!0):!1}var et=class extends Error{constructor(e,t){super(e),this.name=`InvalidPhoneError`,this.details=t}},tt=class extends Error{constructor(e){super(e),this.name=`ServiceError`}},nt=`c43204c2a5e320e5600d73ce305b6f0d`;async function rt(e){let t=`https://apilayer.net/api/validate?access_key=${nt}&number=${encodeURIComponent(e)}`;try{let e=await fetch(t);if(!e.ok)throw Error(`Error de red: ${e.status}`);let n=await e.json();if(!n.valid)throw new et(`El número no es válido o no existe.`,n);return n}catch(e){throw e instanceof et||e instanceof tt?e:new tt(`No se pudo conectar con el servicio de validación. Intenta más tarde.`)}}function it(e){return`
  ...
  `}function L(e,t){return!e||!e.trim()?`${t} es obligatorio.`:null}function st(e){return/^\+?[1-9]\d{6,14}$/.test(e.trim())?null:`Formato de teléfono inválido. Ej: +541112345678`}function ct(e){let t=new Date(e),n=new Date;return n.setHours(0,0,0,0),t>n?`La fecha no puede ser futura.`:null}function lt(e,t){let n={},r=L(e,`Nombre`);r&&(n.name=r);let i=L(t,`Teléfono`)||st(t);return i&&(n.phone=i),n}function ut(e,t,n){let r={};e||(r.type=`Tipo de servicio es obligatorio.`);let i=L(t,`Fecha`)||ct(t);return i&&(r.date=i),r}function dt(e){return e?null:`Selecciona un tipo de profesional.`}function ft(e){return e?null:`Selecciona una modalidad.`}function pt(e){return!e||!e.trim()?`El nombre del local es obligatorio.`:null}function mt(e){return!e||!e.trim()?`La dirección es obligatoria.`:null}function ht(e){return!e||!e.trim()?`El nombre de la empresa es obligatorio.`:null}var R=null;function gt(e){R=e}var z=null;function _t(){z||(z=document.createElement(`div`),z.className=`lightbox-overlay hidden`,z.innerHTML=`
  ...
  `}function Et(e,t){if(t.length===0){e.innerHTML=`<p class="sidebar-empty">Sin clientes</p>`;return}e.innerHTML=t.map(e=>{let t=e.name.split(` `).map(e=>e[0]).join(``).toUpperCase().substring(0,2),n=e.services?.length?e.services.reduce((e,t)=>new Date(t.date)>new Date(e.date)?t:e):null,r=n?Ot(n.date):`Sin servicios`;return`
    ...
    `}).join(``)}async function Y(e,t){let n=await He(e);if(!n){t.innerHTML=`<p>Cliente no encontrado.</p>`;return}let r=await I(e),i=[...r].sort((e,t)=>new Date(t.date)-new Date(e.date));t.innerHTML=`
    <!-- Client Header -->
  ...
  `,document.getElementById(`fab-add-service`).style.display=`flex`;let a=document.getElementById(`btn-toggle-services`),s=document.getElementById(`services-grid`),c=!0;a.addEventListener(`click`,()=>{c=!c,s.style.display=c?``:`none`,a.querySelector(`span:last-child`).textContent=c?`Ocultar servicios`:`Mostrar servicios`,a.querySelector(`.material-symbols-outlined`).textContent=c?`visibility_off`:`visibility`}),document.getElementById(`btn-edit-profile`).addEventListener(`click`,()=>At(n)),document.getElementById(`add-service-area`).addEventListener(`click`,()=>jt()),t.querySelectorAll(`.btn-edit-service-dash`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),Mt(e.dataset.id)})}),t.querySelectorAll(`.btn-delete-service-dash`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),Nt(e.dataset.id)})})}function Dt(e){let t=[];e.beforeImg&&t.push(e.beforeImg),e.afterImg&&t.push(e.afterImg),e.afterLateralImg&&t.push(e.afterLateralImg);let n=o(JSON.stringify(t)),r=t.indexOf(e.beforeImg),i=t.indexOf(e.afterImg),a=t.indexOf(e.afterLateralImg),s=new Date(e.date),c=s.getDate(),l=s.toLocaleString(`es-ES`,{month:`short`}),u=s.getFullYear();return`
  ...
  `}function Ot(e){let t=new Date,n=new Date(e),r=t-n,i=Math.floor(r/6e4);if(i<60)return`Hace ${i} minutos`;let a=Math.floor(i/60);if(a<24)return`Hace ${a} horas`;let o=Math.floor(a/24);return o===1?`Ayer`:o<7?`Hace ${o} días`:n.toLocaleDateString(`es-ES`)}async function kt(){G(`Nuevo Cliente`,`
  ...
  `),document.getElementById(`new-client-form`).addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`client-name`).value.trim(),n=document.getElementById(`client-country`).value,r=Ke(n,document.getElementById(`client-phone`).value.trim()),i=lt(t,r);if(X(`client`,i),Object.keys(i).length>0)return;let a=document.getElementById(`validate-btn`),s=document.getElementById(`validation-area`);if((await A()).find(e=>e.phone===r)){s.innerHTML=`<div class="validation-error">El teléfono ya está registrado.</div>`;return}a.disabled=!0,a.innerHTML=`<span class="spinner"></span> Validando...`,s.innerHTML=``;try{let e=await rt(r);s.innerHTML=`
        <div class="validation-result">
        ...
        </div>`,await Ue({id:Date.now().toString(36)+Math.random().toString(36).substr(2),name:t,phone:r,phoneValid:!0,phoneDetails:{country:e.country_name,carrier:e.carrier,line_type:e.line_type},services:[]}),K(),await q(),P(`Cliente creado correctamente`)}catch(e){e.name===`InvalidPhoneError`?(s.innerHTML=`
          ...
          <button type="button" id="force-save-btn">Guardar manualmente</button>`,document.getElementById(`force-save-btn`).addEventListener(`click`,async()=>{await Ue({id:Date.now().toString(36)+Math.random().toString(36).substr(2),name:t,phone:r,phoneValid:!1,phoneDetails:null,services:[]}),K(),await q()})):s.innerHTML=`<div class="validation-error">${o(e.message)}</div>`}finally{a.disabled=!1,a.innerHTML=`Validar y Guardar`}})}async function At(e){G(`Editar Cliente`,it(e)),document.getElementById(`edit-client-form`).addEventListener(`submit`,async t=>{t.preventDefault();let n=document.getElementById(`edit-client-name`).value.trim(),r=document.getElementById(`edit-client-phone`).value.trim(),i=lt(n,r);if(X(`edit-client`,i),Object.keys(i).length>0)return;await We(e.id,{name:n,phone:r}),K(),await q();let a=document.getElementById(`main-content-area`);R===e.id&&await Y(e.id,a),P(`Cliente actualizado`)})}async function jt(){if(!R){N(`Selecciona un cliente primero.`);return}let e=qe();G(`Agregar Servicio`,at(e.beforeImg,e.afterImg,e.afterLateralImg));let t=document.getElementById(`new-service-form`),n=e.beforeImg,r=e.afterImg,i=e.afterLateralImg;document.getElementById(`btn-regenerate-images`).addEventListener(`click`,()=>{let e=qe();n=e.beforeImg,r=e.afterImg,i=e.afterLateralImg,document.getElementById(`preview-before`).src=n,document.getElementById(`preview-after-frontal`).src=r,document.getElementById(`preview-after-lateral`).src=i}),t.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`service-type`).value,a=document.getElementById(`service-date`).value,o=document.getElementById(`service-notes`).value.trim(),s=ut(t,a,o);X(`service`,s),!(Object.keys(s).length>0)&&(await Ze(R,{id:Date.now().toString(36)+Math.random().toString(36).substr(2),clientId:R,date:a,type:t,notes:o,beforeImg:n,afterImg:r,afterLateralImg:i}),K(),await Y(R,document.getElementById(`main-content-area`)),P(`Servicio agregado`))})}async function Mt(e){let t=(await I(R)).find(t=>t.id===e);t&&(G(`Editar Servicio`,ot(t)),document.getElementById(`edit-service-form`).addEventListener(`submit`,async t=>{t.preventDefault();let n=document.getElementById(`edit-service-type`).value,r=document.getElementById(`edit-service-date`).value,i=document.getElementById(`edit-service-notes`).value.trim(),a=ut(n,r,i);X(`edit-service`,a),!(Object.keys(a).length>0)&&(await Qe(R,e,{type:n,date:r,notes:i}),K(),await Y(R,document.getElementById(`main-content-area`)),P(`Servicio actualizado`))}))}async function Nt(e){await Ct(`¿Eliminar este servicio?`)&&(await $e(R,e),await Y(R,document.getElementById(`main-content-area`)),P(`Servicio eliminado`))}function X(e,t){[`name`,`phone`,`type`,`date`].forEach(n=>{let r=document.getElementById(`error-${e}-${n}`);r&&(r.textContent=t[n]||``)})}async function Pt(e){let t=localStorage.getItem(`sr-client-phone`);if(!t){e.innerHTML=`<p class="login-support">No se encontró sesión de cliente.</p>`;return}let n=await Ve(t);if(!n){e.innerHTML=`<p class="login-support">Perfil de cliente no encontrado.</p>`;return}let r=await I(n.id),i=[...r].sort((e,t)=>new Date(t.date)-new Date(e.date)),a=r.length,s=r.length>0?new Date(i[i.length-1].date).getFullYear():new Date().getFullYear(),c=ne(n.id),l=`${window.location.origin}${window.location.pathname}?token=${c}`;e.innerHTML=`
  ...
  `}function It(e){return e.split(` `).map(e=>e[0]).join(``).toUpperCase().substring(0,2)}async function Lt(e,t){let n=re(t);if(!n){e.innerHTML=`
      ...
      </section>`;return}let r=await He(n);if(!r){e.innerHTML=`<p>Perfil no encontrado.</p>`;return}let i=await I(n),a=[...i].sort((e,t)=>new Date(t.date)-new Date(e.date)),s=i.length,c=a.length>0?a[0]:null;e.innerHTML=`
        ...
        <aside class="shared-sidebar">
          <div class="summary-card">
            ...
            <div class="summary-row">
              ...
              <span class="font-semibold">${c?zt(c.date):`—`}</span>
            </div>
            <div class="summary-row">
  ...
  `,Bt(),document.querySelectorAll(`.shared-service-card`).forEach(e=>{e.addEventListener(`mouseenter`,()=>e.classList.add(`elevated`)),e.addEventListener(`mouseleave`,()=>e.classList.remove(`elevated`))})}function Rt(e){let t=new Date(e.date);return`
  ...
  `}function zt(e){return new Date(e).toLocaleDateString(`es-ES`,{day:`numeric`,month:`short`,year:`numeric`})}function Bt(){let e=document.getElementById(`expiration-countdown`);if(!e)return;function t(){let t=new Date,n=new Date(t);n.setHours(23,59,59,999);let r=n-t;if(r<=0){e.textContent=`Expirado`;return}e.textContent=`${Math.floor(r/36e5).toString().padStart(2,`0`)}:${Math.floor(r%36e5/6e4).toString().padStart(2,`0`)}:${Math.floor(r%6e4/1e3).toString().padStart(2,`0`)}`}t(),setInterval(t,1e3)}var Vt=`modulepreload`,Ht=function(e){return`/StyleRecordLite/`+e},Ut={},Wt=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Ht(t,n),t in Ut)return;Ut[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Vt,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Z=0,Q={type:``,modality:``,businessName:``,address:``,workFromHome:!1,companyId:``,companyName:``,requestLink:!1};function Gt(e){Z=0,Object.keys(Q).forEach(e=>{Q[e]=Q[e]===!1?!1:``}),Q.workFromHome=!1,Q.requestLink=!1,$(e)}function $(e){let t=(Z+1)/3*100;F(800,200,`salon`),e.innerHTML=`
    <section class="register-view-container fade-in">
      ...
      <div class="register-card">
        <div class="register-card-header">
          <h1 class="register-card-title">${Kt(Z)}</h1>
          <p class="register-card-subtitle">${qt(Z)}</p>
        </div>
  ...
  `;let n=document.getElementById(`btn-cancel`);if(n&&n.addEventListener(`click`,()=>{window.location.hash=`/rol`}),Z>0){let t=document.getElementById(`btn-prev`);t&&t.addEventListener(`click`,()=>{Z--,$(e)})}let r=document.getElementById(`btn-next`);r&&r.addEventListener(`click`,()=>Qt(e)),Z===0&&nn(),Z===1&&rn()}function Kt(e){switch(e){case 0:return`Información Profesional`;case 1:return`Detalles del Negocio`;case 2:return`Resumen del Registro`;default:return``}}function qt(e){switch(e){case 0:return`Completa los detalles de tu especialidad para comenzar a gestionar tu agenda con StyleRecord Lite.`;case 1:return Q.modality===`independent`?`Configura los datos de tu actividad independiente.`:`Vincula tu perfil con la empresa donde trabajas.`;case 2:return`Revisa que toda la información sea correcta antes de finalizar.`;default:return``}}function Jt(e){switch(e){case 0:return Yt();case 1:return Xt();case 2:return Zt();default:return``}}function Yt(){return`
  ...
  `}function Xt(){return Q.modality===`independent`?`
  ...
  `}async function Qt(e){if(Z===0){if(!$t())return;Z++,$(e)}else if(Z===1){if(!en())return;Z++,$(e)}else if(Z===2){await tn(),P(`Registro completado correctamente.`);let{loginAsProfessional:e}=await Wt(async()=>{let{loginAsProfessional:e}=await Promise.resolve().then(()=>l);return{loginAsProfessional:e}},void 0);e(`1234`),window.location.hash=`/professional`}}function $t(){let e=document.getElementById(`prof-type`)?.value,t=document.querySelector(`input[name="modality"]:checked`)?.value,n=dt(e),r=ft(t);return document.getElementById(`error-type`).textContent=n||``,document.getElementById(`error-modality`).textContent=r||``,n||r?!1:(Q.type=e,Q.modality=t,!0)}function en(){if(Q.modality===`independent`){let e=document.getElementById(`business-name`)?.value.trim(),t=document.getElementById(`address`)?.value.trim(),n=document.getElementById(`work-from-home`)?.checked||!1,r=pt(e),i=null;return n||(i=mt(t)),document.getElementById(`error-business-name`).textContent=r||``,document.getElementById(`error-address`).textContent=i||``,r||i?!1:(Q.businessName=e,Q.address=t,Q.workFromHome=n,!0)}else{let e=document.getElementById(`selected-company-id`)?.value,t=document.getElementById(`new-company-name`)?.value.trim();if(!e&&!t)return document.getElementById(`error-company-name`).textContent=`Debes seleccionar una empresa o ingresar un nombre nuevo.`,!1;if(t&&!e){let e=ht(t);if(e)return document.getElementById(`error-company-name`).textContent=e,!1;Q.companyName=t,Q.companyId=``}else if(e){Q.companyId=e;let t=document.getElementById(`selected-company-display`);Q.companyName=t?t.textContent.replace(`Empresa: `,``):``}return Q.requestLink=!0,!0}}async function tn(){let e=`prof_`+Date.now().toString(36)+Math.random().toString(36).substr(2,5),t={id:e,type:Q.type,modality:Q.modality,createdAt:new Date().toISOString()};if(Q.modality===`independent`&&(t.businessName=Q.businessName,t.address=Q.workFromHome?`A domicilio`:Q.address,t.workFromHome=Q.workFromHome),await Le(t),Q.modality===`employed`){let t=Q.companyId;t||(t=`comp_`+Date.now().toString(36)+Math.random().toString(36).substr(2,5),await Re({id:t,name:Q.companyName,createdAt:new Date().toISOString()})),await Be({id:`link_`+Date.now().toString(36)+Math.random().toString(36).substr(2,5),professionalId:e,companyId:t,status:`pending`,requestedAt:new Date().toISOString()})}}function nn(){document.querySelectorAll(`input[name="modality"]`).forEach(e=>{e.addEventListener(`change`,function(){document.querySelectorAll(`.radio-card`).forEach(e=>e.classList.remove(`selected`)),this.closest(`.radio-card`).classList.add(`selected`)})})}function rn(){if(Q.modality===`employed`){let e=document.getElementById(`company-search`),t=document.getElementById(`company-suggestions`),n=document.getElementById(`new-company-name`);e?.addEventListener(`input`,async e=>{let n=e.target.value.trim();if(n.length<2){t.classList.add(`hidden`);return}let r=await ze(n);t.innerHTML=r.length===0?`<li class="no-results">No se encontraron empresas</li>`:r.map(e=>`<li data-id="${o(e.id)}">${o(e.name)}</li>`).join(``),t.classList.remove(`hidden`)}),t?.addEventListener(`click`,r=>{let i=r.target.closest(`li`);!i||!i.dataset.id||(document.getElementById(`selected-company-id`).value=i.dataset.id,document.getElementById(`selected-company-display`).textContent=`Empresa: ${i.textContent}`,e.value=i.textContent,t.classList.add(`hidden`),n.value=``,document.getElementById(`error-company-name`).textContent=``)}),n?.addEventListener(`input`,()=>{document.getElementById(`selected-company-id`).value=``,document.getElementById(`selected-company-display`).textContent=``,e.value=``,t.innerHTML=``,t.classList.add(`hidden`)}),document.addEventListener(`click`,e=>{e.target.closest(`.autocomplete-wrapper`)||t?.classList.add(`hidden`)})}}document.addEventListener(`DOMContentLoaded`,async()=>{await a(),ie(),wt();let e=document.createElement(`div`);e.id=`offline-banner`,e.className=`offline-banner hidden`,e.innerHTML=`<i class="fas fa-wifi-slash"></i> ${b(`offline`)}`,document.body.appendChild(e),window.addEventListener(`online`,()=>e.classList.add(`hidden`)),window.addEventListener(`offline`,()=>e.classList.remove(`hidden`));let t=document.getElementById(`modal-close`),n=document.getElementById(`modal-overlay`);t&&t.addEventListener(`click`,K),n&&n.addEventListener(`click`,e=>{e.target===e.currentTarget&&K()});let r=document.getElementById(`btn-logout`);r&&r.addEventListener(`click`,()=>{m(),window.location.hash=`/home`,window.location.reload()});let i=document.getElementById(`main-header`);i&&window.addEventListener(`scroll`,()=>{i.classList.toggle(`scrolled`,window.scrollY>10)});let o=new URLSearchParams(window.location.search).get(`token`);if(o){document.body.classList.remove(`dashboard-mode`);let e=document.querySelector(`main`);e.innerHTML=``,await Lt(e,o),window.addEventListener(`hashchange`,()=>{window.location.href=window.location.origin+window.location.pathname+window.location.hash});return}let s=oe(),c=document.querySelector(`main`);s.addRoute(`/home`,()=>{document.body.classList.remove(`dashboard-mode`),r&&(r.style.display=`none`),se(c)}),s.addRoute(`/rol`,()=>{document.body.classList.remove(`dashboard-mode`),r&&(r.style.display=`none`),le(c)}),s.addRoute(`/login`,()=>{document.body.classList.remove(`dashboard-mode`),r&&(r.style.display=`none`),Je(c)}),s.addRoute(`/register`,()=>{document.body.classList.remove(`dashboard-mode`),r&&(r.style.display=`none`),Gt(c)}),s.addRoute(`/professional`,async()=>{if(!h()||p()!==`professional`){s.navigate(`/login?role=professional`);return}await Tt(c)}),s.addRoute(`/client`,async()=>{if(document.body.classList.remove(`dashboard-mode`),!h()||p()!==`client`){s.navigate(`/login?role=client`);return}r&&(r.style.display=`block`),await Pt(c)}),s.addRoute(`*`,()=>s.navigate(`/home`)),s.start()});